...
export const DncHero = () => {
  return (
    <section id="top" className="relative pt-4 sm:pt-8 pb-10 sm:pb-14 px-3 sm:px-6 max-w-7xl mx-auto scroll-mt-24">
      {/* Side spaces gutter badges (Desktop) */}
      <DncSectionFlanks
        leftIndex="01"
        leftTag="HERO"
        leftBadgeText="⚡ 1-DAY FLAGSHIP"
        leftBadgeColor="bg-[#FFE600] text-black"
        leftSub="AMRAVATI 2026"
        rightIndex=".NET 11"
        rightTag="C# 14"
      ...
      <div className="flex flex-wrap items-center justify-between gap-2.5 mb-4 sm:mb-6 max-w-5xl mx-auto">
        <div className="inline-flex items-center gap-1.5 sm:gap-2 bg-[#EEEAFB] text-[#512BD4] font-mono font-bold text-[11px] sm:text-xs px-3 sm:px-3.5 py-1 sm:py-1.5 rounded-full border-[1.5px] sm:border-[2px] border-black shadow-[1.5px_1.5px_0px_0px_#000]">
          <span className="w-2 h-2 rounded-full bg-[#512BD4] animate-pulse"></span>
          <span className="truncate">{eventData.organizer.badge}</span>
        </div>
        ...
        <div className="inline-flex items-center gap-1.5 sm:gap-2 bg-[#E0F7FA] text-[#006064] font-mono font-bold text-[11px] sm:text-xs px-3 sm:px-3.5 py-1 sm:py-1.5 rounded-full border-[1.5px] sm:border-[2px] border-black shadow-[1.5px_1.5px_0px_0px_#000]">
          <span className="w-2 h-2 rounded-full bg-[#00BDD6]"></span>
      ...
      <div className="relative bg-white border-[2.5px] sm:border-[3px] border-black rounded-3xl p-5 sm:p-8 md:p-12 shadow-[5px_5px_0px_0px_#000] sm:shadow-[8px_8px_0px_0px_#000] max-w-5xl mx-auto overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left order-2 lg:order-1">
            ...
            <div className="inline-flex items-center gap-2 bg-[#FAF8FF] border-[1.5px] sm:border-[2px] border-black rounded-full px-3 py-1 mb-3.5 sm:mb-4 shadow-[1.5px_1.5px_0px_0px_#000]">
              ...
              <span className="text-[10px] sm:text-[11px] font-mono font-bold text-black uppercase tracking-wider">
                {eventData.dateFormatted}
              </span>
            </div>

            {/* Block-Aligned Main Headline */}
            ...
            {/* Exact Description from Hero.jsx */}
            ...
            {/* Action Buttons matching Hero.jsx */}
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full mb-5 sm:mb-6">
              <a
                ...
                className="bg-[#512BD4] hover:bg-[#4322B0] text-white font-black text-xs sm:text-sm md:text-base font-sans uppercase px-6 py-3.5 rounded-2xl border-[2.5px] border-black shadow-[3px_3px_0px_0px_#000] sm:shadow-[4px_4px_0px_0px_#000] hover:shadow-[1px_1px_0px_0px_#000] hover:translate-x-[2px] hover:translate-y-[2px] transition-all flex items-center justify-center gap-2 text-center cursor-pointer"
              >
              ...
              <a
                ...
                className="bg-white hover:bg-[#EEEAFB] text-[#512BD4] font-black text-xs sm:text-sm md:text-base font-sans uppercase px-5 py-3.5 rounded-2xl border-[2.5px] border-black shadow-[3px_3px_0px_0px_#000] sm:shadow-[4px_4px_0px_0px_#000] hover:shadow-[1px_1px_0px_0px_#000] hover:translate-x-[2px] hover:translate-y-[2px] transition-all flex items-center justify-center gap-2 text-center cursor-pointer"
              >
            ...
            {/* Announcement Notice Card from Hero.jsx */}
            <div className="w-full bg-[#FAF8FF] border-[1.5px] sm:border-[2px] border-black rounded-2xl p-3.5 sm:p-4 shadow-[2.5px_2.5px_0px_0px_#000]">
          ...
          {/* Right Column: 3D Rocket Mascot */}
          <div className="lg:col-span-5 flex flex-col items-center justify-center relative order-1 lg:order-2">
            <div className="relative w-full max-w-[220px] xs:max-w-[260px] sm:max-w-[300px] lg:max-w-[350px] bg-[#FAF8FF] border-[2.5px] border-black rounded-3xl p-4 sm:p-6 shadow-[4px_4px_0px_0px_#512BD4] sm:shadow-[6px_6px_0px_0px_#512BD4] flex flex-col items-center">
              {/* Mascot image */}
